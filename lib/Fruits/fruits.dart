...
import 'package:flutter_grocery_shopping/Fruits/avocado.dart';
import 'package:flutter_grocery_shopping/Fruits/kiwi.dart';
              ...
              child: Container(
                child: Row(
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
//                        _buildFruitCard("Kiwi", "assets/kiwi.png", "₹90",
//                            0xffF7DFB9, 0XffFAF0DA),
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => Kiwi()));
                          },
                          child: _buildFruitCard("kiwi", "assets/kiwi.png",
                        ...
                        _buildFruitCard("Mango", "assets/mango.png", "₹150",
